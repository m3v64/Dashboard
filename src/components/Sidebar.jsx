  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-4 py-5 border-b border-white/5">
        ...
        {!collapsed && (
          <span
            className="tracking-[0.2em] uppercase text-cyan-300"
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`relative w-full flex items-center gap-3 px-3 py-2.5 rounded transition-all duration-200 cursor-pointer ${
                isActive
      ...
      <button
        onClick={onToggle}
        className="absolute -right-3 top-1/2 -translate-y-1/2 w-6 h-6 rounded-full flex items-center justify-center text-cyan-400 bg-gray-900 border border-cyan-500/20 hover:bg-cyan-500/10 transition-all cursor-pointer z-10"
      >
